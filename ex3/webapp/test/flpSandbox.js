					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 C18",
									"targetURL": "#syncc18ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"syncc18ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex3",
									"url": sap.ui.require.toUrl("sync/c18/ex3")
								}
							}
						}
					}
