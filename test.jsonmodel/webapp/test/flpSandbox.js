		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#syncc18testjsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18testjsonmodel-display": {
								"semanticObject": "syncc18testjsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.jsonmodel",
									"url": sap.ui.require.toUrl("sync/c18/test/jsonmodel")
								}
							}
						}
					}
