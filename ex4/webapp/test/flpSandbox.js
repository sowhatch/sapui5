					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 C18",
									"targetURL": "#syncc18ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"syncc18ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex4",
									"url": sap.ui.require.toUrl("sync/c18/ex4")
								}
							}
						}
					}
