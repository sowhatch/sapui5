		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment 연습",
									"targetURL": "#syncc18testfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18testfragment-display": {
								"semanticObject": "syncc18testfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.fragment",
									"url": sap.ui.require.toUrl("sync/c18/test/fragment")
								}
							}
						}
					}
