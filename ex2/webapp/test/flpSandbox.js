					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 C18",
									"targetURL": "#syncc18ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"syncc18ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex2",
									"url": sap.ui.require.toUrl("sync/c18/ex2")
								}
							}
						}
					}
