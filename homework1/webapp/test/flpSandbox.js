		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ui5C18homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5C18homework1-display": {
								"semanticObject": "ui5C18homework1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.C18.homework1",
									"url": sap.ui.require.toUrl("ui5/C18/homework1")
								}
							}
						}
					}
