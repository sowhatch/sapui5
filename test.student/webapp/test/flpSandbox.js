		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 관리 프로그램",
									"targetURL": "#syncc18teststudent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18teststudent-display": {
								"semanticObject": "syncc18teststudent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.student",
									"url": sap.ui.require.toUrl("sync/c18/test/student")
								}
							}
						}
					}
