		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncc18testuitable58-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18testuitable58-display": {
								"semanticObject": "syncc18testuitable58",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.ui.table.58",
									"url": sap.ui.require.toUrl("sync/c18/test/ui/table/58")
								}
							}
						}
					}
