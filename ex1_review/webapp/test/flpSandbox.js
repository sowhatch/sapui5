		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습문제 1번 리뷰",
									"targetURL": "#syncc18ex1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18ex1review-display": {
								"semanticObject": "syncc18ex1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex1review",
									"url": sap.ui.require.toUrl("sync/c18/ex1review")
								}
							}
						}
					}
