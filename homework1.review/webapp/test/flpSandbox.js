		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5c18homework1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5c18homework1review-display": {
								"semanticObject": "ui5c18homework1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.c18.homework1.review",
									"url": sap.ui.require.toUrl("ui5/c18/homework1/review")
								}
							}
						}
					}
