		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습문제 3번 리뷰",
									"targetURL": "#syncc18ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18ex3review-display": {
								"semanticObject": "syncc18ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex3review",
									"url": sap.ui.require.toUrl("sync/c18/ex3review")
								}
							}
						}
					}
