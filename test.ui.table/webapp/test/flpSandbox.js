		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공사 관리 (sap.ui.table.Table)",
									"targetURL": "#syncc18testuitable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18testuitable-display": {
								"semanticObject": "syncc18testuitable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.ui.table",
									"url": sap.ui.require.toUrl("sync/c18/test/ui/table")
								}
							}
						}
					}
