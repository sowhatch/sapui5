		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습문제 2번 리뷰",
									"targetURL": "#syncc18ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18ex2review-display": {
								"semanticObject": "syncc18ex2review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.ex2review",
									"url": sap.ui.require.toUrl("sync/c18/ex2review")
								}
							}
						}
					}
