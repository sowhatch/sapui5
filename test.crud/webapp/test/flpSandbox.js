		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공사 관리",
									"targetURL": "#syncc18testcrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc18testcrud-display": {
								"semanticObject": "syncc18testcrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c18.test.crud",
									"url": sap.ui.require.toUrl("sync/c18/test/crud")
								}
							}
						}
					}
